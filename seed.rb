...
class DbSeeds
	def self.seed
		...
		Project.create({:display_name =>"Law Office of Patrick B. Long", :name => "long_law", :description => "Using wordpress, I was able to get the Law Office of Patrick B. Long online in under 48 hours, with a site that looks good not only on desktops, but all mobile devices. View the Law Office of Patrick B. Long <a href='http://http://www.patblonglaw.com/'>here</a>.", :category => "wordpress"})
	end
end